    ...
    <div className={styles.heroWrapper} ref={containerRef}>
      ...
      >
        ...
        <motion.h1
          ...
          custom={1}
        >
          Projects that <span className={styles.highlightWord}>#perform.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Explore a curated selection of our finest digital experiences. We combine immersive aesthetics with bulletproof engineering.
        </motion.p>
      </motion.section>
